...
dit = 25. #Detector integration time
nexp = 1. #Number of exposure co-adds
targ_exp = 900. #Target exposure depth in seconds
...
fileout1 = open('pointing_coords_all_J.txt','w')
print >> fileout1, "# Tile		Paw		SpDither	RA				Dec"

fileout2 = open('pointing_coords_spiral_J.txt','w')
...
n = 18. #Number of pointings in the spiral
...
if len(sys.argv) > 1:
	if sys.argv[1] == 'probe':
		...
		plt.savefig('vircam_probes_J.pdf')
